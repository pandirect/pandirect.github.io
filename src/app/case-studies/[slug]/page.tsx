                    ...
                    <div className="container mx-auto px-4">
                        <div className="max-w-4xl mx-auto">
                            <div
                                ...
                                <div>
                                    <h3 className="font-semibold text-muted-foreground text-sm mb-2">Специализация</h3>
                                    <p className="text-foreground">{study.industry}</p>
                                </div>
                                <div>
                                    <h3 className="font-semibold text-muted-foreground text-sm mb-2">Клиент</h3>
                                    <p className="text-foreground">{study.client}</p>
                                </div>
                                <div>
                                    <h3 className="font-semibold text-muted-foreground text-sm mb-2">Тип проекта</h3>
                            ...
                            <div className="space-y-12">
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <h2 className="text-2xl font-semibold">Наше решение</h2>
                                    </div>
                                    <article
                                        className="prose prose-invert max-w-none prose-p:text-light-gray prose-headings:text-foreground prose-strong:text-foreground prose-a:text-primary hover:prose-a:text-primary/80 prose-li:text-light-gray">
                                            ...
                                            <Card className="bg-secondary/20 border-secondary">
                                                <CardContent className="p-6">
                                                    ...
                                                    <div className="flex items-center">
                                                        <Avatar>
                                                            <AvatarImage src={study.testimonial.avatar}
                            ...
                            <div className="mt-16">
                                <div className="flex items-center space-x-4 mb-6">
                                    ...
                                    <h2 className="text-2xl font-semibold">Используемые технологии</h2>
                                </div>
                                <div className="flex flex-wrap gap-3">
                                    {study.technologies.map(tech => (
                                        <Badge key={tech} variant="outline"
                                               className="text-md px-4 py-2 bg-secondary/20 border-secondary hover:bg-secondary/50">{tech}</Badge>
                                    ))}
                                </div>
                            </div>
