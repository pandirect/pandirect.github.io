      ...
      <section id="case-studies" className="section-padding bg-background">
        <div className="container mx-auto px-4">
          <ScrollFadeIn className="text-center mb-12">
            <h1 className="text-3xl md:text-5xl font-bold mb-4">{t('title', 'Our Case Studies')}</h1>
            <p className="text-light-gray max-w-3xl mx-auto">{t('description', 'Explore some of our favorite projects.')}</p>
          </ScrollFadeIn>
                    ...
                    <Card className="group h-full flex flex-col overflow-hidden rounded-lg shadow-lg transition-all duration-300 hover:shadow-primary/20 hover:-translate-y-1 bg-secondary/20 border-secondary">
                      ...
                      <CardContent className="p-6 flex flex-col flex-grow">
                        <div className="flex-grow">
                          ...
                          <div className="mb-4">
                            <h4 className="font-semibold text-sm mb-2 text-gray-300">Результат: <span className="font-normal text-gray-400">{item.card.result}</span></h4>
                          </div>
                        </div>
                        ...
                        <div className="inline-flex items-center text-primary font-semibold group-hover:underline mt-auto pt-4 border-t border-secondary">
                          Смотреть кейс <ArrowRight className="ml-2 h-4 w-4 transition-transform duration-300 group-hover:translate-x-1" />
                        </div>
                      </CardContent>
                    </Card>
                  </Link>
